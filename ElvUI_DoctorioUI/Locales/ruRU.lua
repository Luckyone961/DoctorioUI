...
L["Please click the button below to get the Wago URL for Doctorios SkironCooldownManager profile."] = "Нажмите кнопку ниже, чтобы применить профиль Doctorios для SkironCooldownManager."
...
L["SkironCooldownManager"] = "SkironCooldownManager"
