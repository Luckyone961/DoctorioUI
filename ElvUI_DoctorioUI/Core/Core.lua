...
function DoctorioUI:Setup_ElvUI_Nameplates()
	...
	E.db["nameplates"]["colors"]["castColor"]["b"] = 0
	E.db["nameplates"]["colors"]["castColor"]["g"] = 0.78431379795074
	E.db["nameplates"]["colors"]["castColor"]["r"] = 0
	E.db["nameplates"]["colors"]["castInterruptedColor"]["a"] = 1
	E.db["nameplates"]["colors"]["castInterruptedColor"]["b"] = 0
	E.db["nameplates"]["colors"]["castInterruptedColor"]["g"] = 0
	E.db["nameplates"]["colors"]["castInterruptedColor"]["r"] = 0.78431379795074
	E.db["nameplates"]["colors"]["castNoInterruptColor"]["a"] = 1
	E.db["nameplates"]["colors"]["castNoInterruptColor"]["b"] = 0.58823531866074
	E.db["nameplates"]["colors"]["castNoInterruptColor"]["g"] = 0.58823531866074
	E.db["nameplates"]["colors"]["castNoInterruptColor"]["r"] = 0.58823531866074
	...
	E.db["nameplates"]["units"]["ENEMY_NPC"]["buffs"]["useBlocklist"] = true
