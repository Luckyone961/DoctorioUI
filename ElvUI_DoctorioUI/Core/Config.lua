...
function DoctorioUI:Config()
	...
	DoctorioUI.Options.args.weakauras.args.shaman = ACH:Group(L["Shaman"], nil, 5)
	...
	DoctorioUI.Options.args.weakauras.args.monk = ACH:Group(L["Monk"], nil, 6)
	...
	DoctorioUI.Options.args.weakauras.args.paladin = ACH:Group(L["Paladin"], nil, 7)
	...
	DoctorioUI.Options.args.weakauras.args.druid = ACH:Group(L["Druid"], nil, 8)
	...
	DoctorioUI.Options.args.weakauras.args.evoker = ACH:Group(L["Evoker"], nil, 9)
	...
	DoctorioUI.Options.args.weakauras.args.evoker.args.evoker3 = ACH:Execute(format('|cff33937F%s|r', L["Augmentation"]), nil, 21, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioEvokerAugmentation') end)
	DoctorioUI.Options.args.weakauras.args.warrior = ACH:Group(L["Warrior"], nil, 10)
	DoctorioUI.Options.args.weakauras.args.warrior.inline = true
	DoctorioUI.Options.args.weakauras.args.warrior.args.warrior1 = ACH:Execute(format('|cffC69B6D%s|r', L["Arms"]), nil, 22, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioWarriorArms') end)
	DoctorioUI.Options.args.weakauras.args.warrior.args.warrior2 = ACH:Execute(format('|cffC69B6D%s|r', L["Fury"]), nil, 23, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioWarriorFury') end)
	DoctorioUI.Options.args.weakauras.args.warrior.args.warrior3 = ACH:Execute(format('|cffC69B6D%s|r', L["Protection"]), nil, 24, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioWarriorProtection') end)
	DoctorioUI.Options.args.weakauras.args.dk = ACH:Group(L["Death Knight"], nil, 11)
	DoctorioUI.Options.args.weakauras.args.dk.inline = true
	DoctorioUI.Options.args.weakauras.args.dk.args.dk1 = ACH:Execute(format('|cffC41E3A%s|r', L["Unholy"]), nil, 25, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioDeathknightUnholy') end)
	DoctorioUI.Options.args.weakauras.args.dk.args.dk2 = ACH:Execute(format('|cffC41E3A%s|r', L["Frost"]), nil, 26, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioDeathknightFrost') end)
	DoctorioUI.Options.args.weakauras.args.dk.args.dk3 = ACH:Execute(format('|cffC41E3A%s|r', L["Blood"]), nil, 27, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioDeathknightBlood') end)
	DoctorioUI.Options.args.weakauras.args.dh = ACH:Group(L["Demon Hunter"], nil, 12)
	DoctorioUI.Options.args.weakauras.args.dh.inline = true
	DoctorioUI.Options.args.weakauras.args.dh.args.dh1 = ACH:Execute(format('|cffA330C9%s|r', L["Havoc"]), nil, 28, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioDemonhunterHavoc') end)
	DoctorioUI.Options.args.weakauras.args.dh.args.dh2 = ACH:Execute(format('|cffA330C9%s|r', L["Vengeance"]), nil, 29, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioDemonhunterVengeance') end)
	DoctorioUI.Options.args.weakauras.args.priest = ACH:Group(L["Priest"], nil, 13)
	DoctorioUI.Options.args.weakauras.args.priest.inline = true
	DoctorioUI.Options.args.weakauras.args.priest.args.priest1 = ACH:Execute(format('|cffFFFFFF%s|r', L["Shadow"]), nil, 30, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioPriestShadow') end)
	DoctorioUI.Options.args.weakauras.args.priest.args.priest2 = ACH:Execute(format('|cffFFFFFF%s|r', L["Discipline"]), nil, 31, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioPriestDiscipline') end)
	DoctorioUI.Options.args.weakauras.args.priest.args.priest3 = ACH:Execute(format('|cffFFFFFF%s|r', L["Holy"]), nil, 32, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioPriestHoly') end)
	DoctorioUI.Options.args.weakauras.args.warlock = ACH:Group(L["Warlock"], nil, 14)
	DoctorioUI.Options.args.weakauras.args.warlock.inline = true
	DoctorioUI.Options.args.weakauras.args.warlock.args.warlock1 = ACH:Execute(format('|cff8788EE%s|r', L["Destruction"]), nil, 33, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioWarlockDestruction') end)
	DoctorioUI.Options.args.weakauras.args.warlock.args.warlock2 = ACH:Execute(format('|cff8788EE%s|r', L["Affliction"]), nil, 34, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioWarlockAffliction') end)
	DoctorioUI.Options.args.weakauras.args.warlock.args.warlock3 = ACH:Execute(format('|cff8788EE%s|r', L["Demonology"]), nil, 35, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioWarlockDemonology') end)
	DoctorioUI.Options.args.weakauras.args.mage = ACH:Group(L["Mage"], nil, 15)
	DoctorioUI.Options.args.weakauras.args.mage.inline = true
	DoctorioUI.Options.args.weakauras.args.mage.args.mage1 = ACH:Execute(format('|cff3FC7EB%s|r', L["Fire"]), nil, 36, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioMageFire') end)
	DoctorioUI.Options.args.weakauras.args.mage.args.mage2 = ACH:Execute(format('|cff3FC7EB%s|r', L["Frost"]), nil, 37, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioMageFrost') end)
	DoctorioUI.Options.args.weakauras.args.mage.args.mage3 = ACH:Execute(format('|cff3FC7EB%s|r', L["Arcane"]), nil, 38, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioMageArcane') end)
	DoctorioUI.Options.args.weakauras.args.rogue = ACH:Group(L["Rogue"], nil, 16)
	DoctorioUI.Options.args.weakauras.args.rogue.inline = true
	DoctorioUI.Options.args.weakauras.args.rogue.args.rogue1 = ACH:Execute(format('|cffFFF468%s|r', L["Assa"]), nil, 39, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioRogueAssassination') end)
	DoctorioUI.Options.args.weakauras.args.rogue.args.rogue2 = ACH:Execute(format('|cffFFF468%s|r', L["Outlaw"]), nil, 40, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioRogueOutlaw') end)
	DoctorioUI.Options.args.weakauras.args.rogue.args.rogue3 = ACH:Execute(format('|cffFFF468%s|r', L["Sub"]), nil, 41, function() E:StaticPopup_Show('DoctorioUI_EDITBOX', nil, nil, 'https://wago.io/DoctorioRogueSubtlety') end)
